...
SQL_CREATE_TABLES = sql_create_vk_user + sql_create_favorites + sql_create_u_f + \
                    sql_create_last_send_person + sql_create_find_people
...
SQL_DROP_TABLES = sql_drop_u_f + sql_drop_favorites + sql_drop_find_people + \
                  sql_drop_last_send_person + sql_drop_vk_user


def get_connection(*, username='postgres', password='your pass', database='your db', hostname='localhost'):

...
class DataBaseInator:
    ...
    def __init__(self, username='postgres', password='3633388', database='bot_users', host='localhost', **kwargs):
        """ инициализация класса (username='postgres', password='1234', database='vkr', host='localhost', **kwargs)

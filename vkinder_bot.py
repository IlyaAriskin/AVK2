...
from classdbinator import DataBaseInator
from get_people import get_user_info, find_people, content_generator
from menu import Command, Position


def bot(user_token, public_token, db_user_name='postgres', db_password='your pass', db='your db', memory_days=0):
            ...
            for event in longpoll.listen():
                ...
                if event.type == VkEventType.USER_TYPING:
                    if position == Position.INTRO:
                        write_msg(user_id, '&#128483;: Привет! &#9996; Для поиска пары нажмите кнопку "Старт"')
                ...
                if event.type == VkEventType.MESSAGE_NEW:
                    if event.to_me:
                        ...
                        if position == Position.INTRO and request.capitalize() == Command.START:
                            ...
                            try:
                                adapted_city, etalon_city = get_city_list(r'путь к файлу:cities.json')
                            ...
                            write_msg(user_id, '&#128483;: Всего доброго! &#129303;')

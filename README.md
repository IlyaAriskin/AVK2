...
## Запуск бота:
- запуск main.py
- ввести токены в tokens.ini
- ввести данные для бд в main.py, vkinder_bot.py, createdatabase.py, classdbinator.py
- указать путь к файлу cities.json в файле vkinder_bot.py
